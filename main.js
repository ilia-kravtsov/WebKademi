...
//
//                            Отличие IV Всплытие Hoisting
// В ES6 невозможно такое явление как Hoisting или "всплытие переменной"

// console.log (a);
// var a = 7 -- в консоли увидим undefined 
// (процесс всплытия поднятия переменной относится только к объявлению)
// Если не присваивать значение а только объявлять переменную это тоже будет работать
// console.log(a);
// var a; -- в консоли увидим undefined

// суть всплытия в том что когда переменная есть в коде и объявлена с помощью var
// даже если она сначала выполняется и только потом объявляется и присваивает значение
// то JS переносит объявление или присваивание переменной выше выполнения,
// однако при объявлении переменной с помощью let или const

// console.log (a);
// let a = 7 -- в консоли увидим ошибку is not defined
// всплытие работает внутри блока (функции), но присвоится значение им уже позже
// когда уже явно произойдет присваивание переменной.
// 
// console.log(a);
// var a = 7;
// console.log(a);
// a = 5;
// console.log(a); -- в консоли увидим undefined, 7, 5
//         
//                                   Типы Данных: -------------------------------------------------
//       Тип I Строка (String)
//
